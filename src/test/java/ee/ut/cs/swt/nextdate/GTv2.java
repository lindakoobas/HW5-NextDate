...
public class GTv2 {
	...
	public void testCreatesNextDate1() throws Throwable {
	    NextDate nextDate0 = new NextDate(3149, 3149, 3149);
	    String string0 = nextDate0.run(3, 30, 1818);
	    assertEquals("3/31/1818", string0);
	}
	...
	public void testRunWithNegative() throws Throwable {
	    NextDate nextDate0 = new NextDate(2021, 2021, 2021);
	    String string0 = nextDate0.run(1472, (-791), 1472);
	    assertEquals("invalid Input Date", string0);
	}
